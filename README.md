...
首页是多活动发现页，而不是某个活动的详情页：顶部轮播当前可报名的精选活动，GPT Pro 20x 保持主推；下方展示全部八个测试活动，支持分类、搜索和独立详情链接。轮播支持手动切换、暂停、键盘与手机滑动，尊重减少动效设置；人数、金额和活动状态共用真实链上快照，结束或满员的活动不会被轮播宣传为可报名。
...
| 多活动首页 | 近期活动轮播、搜索、分类、响应式卡片与独立详情入口 | 八个测试示例；轮播只选可报名活动，不伪造价格或供给 |
